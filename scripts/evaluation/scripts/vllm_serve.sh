...
Optional:
  ...
  --max-num-batched-tokens N     vLLM scheduler token budget (default: 8192)
  --max-num-seqs N               vLLM max concurrent sequences (default: 64)
...
echo "[INFO]   Max num batched tokens: ${MAX_NUM_BATCHED_TOKENS}"
